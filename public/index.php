            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="trata_escolha_user.php?teste_num=1" class="btn btn-primary"><i class="fas fa-play"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="trata_escolha_user.php?teste_num=2" class="btn btn-primary"><i class="fas fa-play"></i></a>
                    </div>
                </div>
            </div>
        </div>
